...
bool WriteSkinWeightsToTexture(const TArray<VertexSkinWeightFour>& SkinWeights, const int32 RowsPerFrame, const int32 Height, const int32 Width, UTexture2D* Texture);
